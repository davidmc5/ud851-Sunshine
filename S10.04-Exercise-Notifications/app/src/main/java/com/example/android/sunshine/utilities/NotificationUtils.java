...
//          DONE (4) Use TaskStackBuilder to create the proper PendingIntent
            //We want to navigate back to the MainActivity from the DetailActivity
            // if the user clicks the Notification and then clicks back,
            // so use TaskStackBuilder for that.
