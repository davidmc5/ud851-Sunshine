...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " + WeatherContract.WeatherEntry.TABLE_NAME + " (" +
                ...
                WeatherContract.WeatherEntry.COLUMN_MIN_TEMP + " FLOAT, " +
                WeatherContract.WeatherEntry.COLUMN_MAX_TEMP + " FLOAT, " +
                WeatherContract.WeatherEntry.COLUMN_HUMIDITY + " FLOAT, " +
                WeatherContract.WeatherEntry.COLUMN_PRESSURE + " FLOAT, " +
                WeatherContract.WeatherEntry.COLUMN_WIND_SPEED + " FLOAT, " +
                WeatherContract.WeatherEntry.COLUMN_DEGREES + " FLOAT " +
                "); ";
