...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE (8) Create a method that will get the user's preferredWeatherLocation (from sunshine preferences)
    // and execute your new AsyncTask and call it loadWeatherData
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        */
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL wxSearchUrl = NetworkUtils.buildUrl(searchLocation);

            try {
                String jsonWeatherResponse = NetworkUtils
                        .getResponseFromHttpUrl(wxSearchUrl);
        ...
        @Override
        protected void onPostExecute(String[] wxResults) {

            // As soon as the loading is complete, hide the loading indicator
            //mLoadingIndicator.setVisibility(View.INVISIBLE);

                for (String wxString : wxResults) {
                    mWeatherTextView.append((wxString) + "\n\n\n");            }
        }
    }
